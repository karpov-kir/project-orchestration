...
var conrollers_1 = require("./conrollers");
var dbUtils_1 = require("./dbUtils");
var entities_1 = require("./entities");
var MainModule = /** @class */ (function () {
    function MainModule(connection) {
        this.connection = connection;
    }
    MainModule.prototype.onApplicationBootstrap = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(0, dbUtils_1.isDbEnabled)()) return [3 /*break*/, 2];
                        return [4 /*yield*/, (0, dbUtils_1.applyDbMigrations)()];
                    case 1:
                        _a.sent();
                        _a.label = 2;
    ...
    MainModule = __decorate([
        (0, common_1.Module)({
            ...
            controllers: [conrollers_1.TextController],
            providers: [],
        }),
