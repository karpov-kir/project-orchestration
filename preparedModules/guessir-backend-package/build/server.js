...
// TODO set up CORS
function boot(host, port) {
    if (host === void 0) { host = '0.0.0.0'; }
    if (port === void 0) { port = 3020; }
    return __awaiter(this, void 0, void 0, function () {
        var logger, app;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    logger = new common_1.Logger(boot.name);
                    ...
                    return [4 /*yield*/, core_1.NestFactory.create(MainModule_1.MainModule, new platform_fastify_1.FastifyAdapter({
                            logger: true,
                        }))];
                case 1:
                    app = _a.sent();
